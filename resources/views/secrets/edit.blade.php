    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            <form id="signupForm" class="col-md-10 mx-auto" method="post"
                action="{{ route('secrets.update', $secret->id) }}" novalidate="novalidate">
                @csrf
                @method('post')
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" name="Add role" value="Add role">Update_Secret</button>
                    </div>
            </form>
        </div>
    </div>
