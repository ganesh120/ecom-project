    ...
    <tbody>
        @foreach ($transaction as $transaction)
            <tr>
                ...
                <td><a href="{{ route('transactions.edit', $transaction->id) }}"><button type="button"
                            class="btn btn-success">Edit</button></a>
                    <a href="{{ route('transactions.delete', $transaction->id) }}"><button type="button"
